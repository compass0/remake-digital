...
class FontTest extends Component{
  ...
  render(){ 
    ...
    return (
      <div>
        <EnterStatement/>
        <WrongResultSave statement={this.state.current_stmt} fontnames={this.state.options}/>
            ...
            <TableBody>
              ...
              return (<TableRow>
                ...
                <TableCell class="checkbox">
                  {this.state.current_stmt_array ? this.state.current_stmt_array.map((i)=>{
                  return (<input
                    type="checkbox"
                    value = {c.name}
                    // checked={this.state.checked}
                    // defaultChecked = {!c.success}
                    defaultChecked = {!c.successbin[i]}
                    onChange={this.handleChange.bind(this)} />
                  )
                  }) :  <p></p> }
                </TableCell>
