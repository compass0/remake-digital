...
def gen_font_image_letter(font, letter, file_disting_num, letter_size = 32, img_path = 'C:\\Users\\remake\\gdrive\\remake\\font-compat-test-service\\data\\image\\letter_display_for_ver3.png'):
...
def main():
    ...
    for index, font in enumerate(kor_font_file_list):
        # print(font)
