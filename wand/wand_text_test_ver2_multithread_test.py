...
def main():
    ...
    Parallel(n_jobs=1)(delayed(render)(font_file_list) for font_file_list in (kor_font_file_list, eng_font_file_list, unclassified_font_file_list))
    
    print(success_num)

def render(font_file_list):
    Parallel(n_jobs=1)(delayed(gen_font_image)(font, input_message) for font in font_file_list)
